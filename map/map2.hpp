...
#include "../includes/iterator_traits.hpp"			// ft::iterator_traits
#include "../includes/reverse_iterator.hpp"		    // ft::reverse_iterator
#include "../includes/pair.hpp"					    // ft::pair
#include "../includes/compare.hpp"					// ft::pair
...
namespace ft
{
	...
	private:
		...
		public:
			...
			Const_Iterator	iter() const { return (Const_Iterator(this)); }
	...
	public:
		...
		map(void) : comp(Compare()), alloc(allocator_type()), _size(0) { }
